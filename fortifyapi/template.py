    ...
    def configure_processing_rules(self):
        return self.api.construct_request('PUT', f"/api/v1/projectVersions/{self.project_version_id}/resultProcessingRules", [
            ...
            {"identifier": "com.fortify.manager.BLL.processingrules.FileCountProcessingRule",
             "enabled": False},
            {"identifier": "com.fortify.manager.BLL.processingrules.FileCountDecreaseProcessingRule",
             "enabled": False},
            {"identifier": "com.fortify.manager.BLL.processingrules.FileCountIncreaseProcessingRule",
             "enabled": False},
            ...
            {"identifier": "com.fortify.manager.BLL.processingrules.LOCCountProcessingRule",
             "enabled": False},
            {"identifier": "com.fortify.manager.BLL.processingrules.LineCountDecreaseProcessingRule",
             "enabled": False},
            {"identifier": "com.fortify.manager.BLL.processingrules.LineCountIncreaseProcessingRule",
             "enabled": False},
